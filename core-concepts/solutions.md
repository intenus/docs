...
✅ **Schema Compliance**: Must conform to IGS standards
✅ **Economic Feasibility**: Simulated execution must succeed
✅ **Constraint Satisfaction**: Must meet all intent requirements
✅ **Solver Authorization**: Must come from verified, staked solver
✅ **Freshness**: Market data must be recent
